...
public class AcAppServiceImpl implements AcAppService {
    ...
    private final static String redirectUrl = "https://app2883.acapp.acwing.com.cn/api/user/account/acwing/acapp/receive_code/"; // 回调函数的URL
    ...
    public JSONObject applyCode() {
        ...
        try {
            resp.put("redirect_uri", URLEncoder.encode(redirectUrl, "UTF-8")); // 对链接进行编码
        ...
        resp.put("state", state.toString()); // acwing服务器返回结果时会带着state，对比是否发送给acwing的state，保证安全
